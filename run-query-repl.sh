...
target="$base/target/planequery-1.0-SNAPSHOT.jar"
...
echo "[info] Executing PlaneQueryClient from planequery-1.0-SNAPSHOT.jar (exit via Control+C)"
echo ""
java -cp $target io.eventador.planequery.PlaneQueryClient $jobId
